...
static const Vec4 av1_default_dc_sign_cdfs
    = {
          { {
                { AOM_CDF2(128 * 125) },
                { AOM_CDF2(128 * 102) },
...
static const Vec4 av1_default_txb_skip_cdfs
    = { { { { AOM_CDF2(31849) },
              { AOM_CDF2(5892) },
              { AOM_CDF2(12112) },
              { AOM_CDF2(21935) },
...
static const Vec5 av1_default_eob_extra_cdfs
    = { { { {
                { AOM_CDF2(16961) },
                { AOM_CDF2(17223) },
                { AOM_CDF2(7621) },
...
static const Vec4 av1_default_eob_multi16_cdfs
...
static const Vec4
    av1_default_eob_multi1024_cdfs
...
static const Vec5 av1_default_coeff_lps_multi_cdfs
    = {
...
static const Vec5 av1_default_coeff_base_multi_cdfs
...
static const Vec5 av1_default_coeff_base_eob_multi_cdfs
...
const Vec3 default_kf_y_mode_cdf
    = {
...
static const Vec2 default_angle_delta_cdf
    = {
...
static const Vec2 default_if_y_mode_cdf
...
static const Vec2 default_partition_cdf
    = {
...
static const Vec4 default_intra_ext_tx_cdf
...
static const Vec1 default_cfl_sign_cdf = {
...
static const Vec2 default_newmv_cdf = { { AOM_CDF2(24035) }, { AOM_CDF2(16630) }, { AOM_CDF2(15339) },
    { AOM_CDF2(8386) }, { AOM_CDF2(12222) }, { AOM_CDF2(4676) } };

static const Vec2 default_zeromv_cdf
    = { { AOM_CDF2(2175) }, { AOM_CDF2(1054) } };

static const Vec2 default_refmv_cdf = { { AOM_CDF2(23974) }, { AOM_CDF2(24188) }, { AOM_CDF2(17848) },
    { AOM_CDF2(28622) }, { AOM_CDF2(24312) }, { AOM_CDF2(19923) } };

static const Vec2 default_drl_cdf = {
...
static const Vec2 default_interintra_cdf
    = { { AOM_CDF2(16384) },
          { AOM_CDF2(26887) },
          { AOM_CDF2(27597) },
          { AOM_CDF2(30237) } };
...
static const Vec2 default_wedge_idx_cdf = { { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                                                20480, 22528, 24576, 26624, 28672, 30720) },
    { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
        20480, 22528, 24576, 26624, 28672, 30720) },
    { AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
...
static const Vec2 default_motion_mode_cdf
...
static const Vec2 default_obmc_cdf = {
    { AOM_CDF2(16384) }, { AOM_CDF2(16384) }, { AOM_CDF2(16384) },
...
static const Vec2 default_intra_inter_cdf
...
static const Vec2 default_comp_inter_cdf
    = { { AOM_CDF2(26828) },
          { AOM_CDF2(24035) },
          { AOM_CDF2(12031) },
          { AOM_CDF2(10640) },
...
static const Vec2 default_comp_ref_type_cdf
...
static const Vec3 default_single_ref_cdf
...
const Vec2 default_palette_uv_size_cdf
    = { { AOM_CDF7(4681, 9362, 14043, 18725, 23406, 28087) },
          { AOM_CDF7(4681, 9362, 14043, 18725, 23406, 28087) },
...
const Vec3 default_palette_y_mode_cdf
...
const Vec3 default_palette_y_color_index_cdf
...
const Vec3 default_palette_uv_color_index_cdf
...
static const Vec2 default_skip_cdfs = {
    { AOM_CDF2(31671) }, { AOM_CDF2(16515) }, { AOM_CDF2(4576) }
};

static const Vec2 default_skip_mode_cdfs
...
static const Vec1 default_intrabc_cdf = { AOM_CDF2(
    30531) };

static const Vec1 default_filter_intra_mode_cdf
    = { AOM_CDF5(8949, 12776, 17211, 29558) };

static const Vec2 default_filter_intra_cdfs
...
static const Vec1 default_switchable_restore_cdf
    = { AOM_CDF3(9413, 22581) };

static const Vec1 default_wiener_restore_cdf = { AOM_CDF2(
    11570) };

static const Vec1 default_sgrproj_restore_cdf = { AOM_CDF2(
    16855) };

static const Vec1 default_delta_q_cdf = {
    AOM_CDF4(28160, 32120, 32677)
};

static const Vec2 default_delta_lf_multi_cdf
    = { { AOM_CDF4(28160, 32120, 32677) },
          { AOM_CDF4(28160, 32120, 32677) },
          { AOM_CDF4(28160, 32120, 32677) },
          { AOM_CDF4(28160, 32120, 32677) } };
static const Vec1 default_delta_lf_cdf = {
    AOM_CDF4(28160, 32120, 32677)
};

// FIXME(someone) need real defaults here
static const Vec1 default_seg_tree_cdf = {
...
static const Vec3 default_tx_size_cdf
...
#define av1_copy(a, b) a = b

void Cdfs::init_non_coeff_cdfs()
{
    ...
    nmv_context[0] = default_nmv_context;
    nmv_context[1] = default_nmv_context;
}
...
void Cdfs::init_coeff_cdfs(uint32_t baseQ)
{
...
{
    load(palette_y_size_cdf);
    load(palette_uv_size_cdf);
    load(palette_y_color_index_cdf);
    load(palette_uv_color_index_cdf);
    load(kf_y_cdf);
    load(angle_delta_cdf);
    load(comp_inter_cdf);
    load(comp_ref_type_cdf);
    load(uni_comp_ref_cdf);
    load(palette_y_mode_cdf);
    load(palette_uv_mode_cdf);
    load(comp_ref_cdf);
    load(comp_bwdref_cdf);
    load(single_ref_cdf);
    load(txfm_partition_cdf);
    load(compound_index_cdf);
    load(comp_group_idx_cdf);
    load(newmv_cdf);
    load(zeromv_cdf);
    load(refmv_cdf);
    load(drl_cdf);
    load(motion_mode_cdf);
    load(obmc_cdf);
    load(inter_compound_mode_cdf);
    load(compound_type_cdf);
    load(wedge_idx_cdf);
    load(interintra_cdf);
    load(wedge_interintra_cdf);
    load(interintra_mode_cdf);
    //load(seg.pred_cdf);
    //load(seg.tree_cdf);
    load(filter_intra_cdfs);
    load(filter_intra_mode_cdf);
    load(switchable_restore_cdf);
    load(wiener_restore_cdf);
    load(sgrproj_restore_cdf);
    load(y_mode_cdf);
    load(uv_mode_cdf);
    load(switchable_interp_cdf);
    load(partition_cdf);
    load(intra_ext_tx_cdf);
    load(inter_ext_tx_cdf);
    load(skip_mode_cdfs);
    load(skip_cdfs);
    load(intra_inter_cdf);
    //for (int i = 0; i < SPATIAL_PREDICTION_PROBS; i++)
    //load(seg.spatial_pred_seg_cdf[i],
    //default_spatial_pred_seg_tree_cdf[i]);
    load(tx_size_cdf);
    load(delta_q_cdf);
    load(delta_lf_cdf);
    load(delta_lf_multi_cdf);
    load(cfl_sign_cdf);
    load(cfl_alpha_cdf);
    load(intrabc_cdf);
    load(txb_skip_cdf);
    ...
    load(coeff_br_cdf);
    load(coeff_base_cdf);
    load(coeff_base_eob_cdf);
    load(eob_flag_cdf16);
    load(eob_flag_cdf32);
    load(eob_flag_cdf64);
    load(eob_flag_cdf128);
    load(eob_flag_cdf256);
    load(eob_flag_cdf512);
    load(eob_flag_cdf1024);

    nmv_context[0].load_cdfs(rhs.nmv_context[0]);
    nmv_context[1].load_cdfs(rhs.nmv_context[1]);
}

void Cdfs::NmvContext::load_cdfs(const NmvContext& rhs)
{
    load(joints_cdf);
    comps[0].load_cdfs(rhs.comps[0]);
    comps[1].load_cdfs(rhs.comps[1]);
}
void Cdfs::nmv_component::load_cdfs(const nmv_component& rhs)
{
    load(classes_cdf);
    load(class0_fp_cdf);
    load(fp_cdf);
